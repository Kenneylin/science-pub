    ...
    render() {
        ...
        return (
            <div className='Deadlines--wrapper'>
                ...
                <p>Invoices will be sent via email as a PDF attachment. In order to receive an invoice on behalf of a company or organization you must state this request in the "Submit a manuscript" form. <strong>If the bank transfer is ordered by a natural person, it is not possible an invoice to a company or organization to be issued afterwards, and vice-versa.</strong></p>
            </div>
        );
    }
}